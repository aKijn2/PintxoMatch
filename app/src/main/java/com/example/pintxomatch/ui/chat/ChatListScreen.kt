...
fun ChatListScreen(
            ...
            when (val state = uiState) {
                ...
                is ChatListUiState.Success -> {
                    if (state.chats.isEmpty()) {
                        Text("No tienes chats activos todavia.", modifier = Modifier.align(Alignment.Center))
                    } else {
                        Column(
    ...
    if (chatToDelete != null) {
        AlertDialog(
            ...
            text = { Text("Esta accion borrara todos los mensajes de este chat.") },
            confirmButton = {
                TextButton(
                    onClick = {
                        chatToDelete?.let(viewModel::deleteChat)
                        chatToDelete = null
                    }
                ) {
                    Text("Eliminar")
